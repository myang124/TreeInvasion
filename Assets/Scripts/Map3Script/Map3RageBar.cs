...
public class Map3RageBar : MonoBehaviour {
    ...
    public void StartRageBar()
        {
            ...
            GetComponent<Map3PlayerMovement>().canMove = false;
        }
    ...
    public void DestroyTree()
    {
        if (GetComponent<TreeBarFixed>()._inZone && GetComponent<TreeTrigger>().Tree11 == true)
        {
            ...
            GetComponent<Map3PlayerMovement>().canMove = true;
            scoreCount += 2;
    ...
    {
        GetComponent<Map3PlayerMovement>().restartPlayer();
        destroyButton.SetActive(false);
        rageBar.SetActive(false);
    }
